...
import { Createtestimonial, Gettestimonial } from "../../../Redux/ActionCreator/Testimonialactioncreator"
    ...
    if (error) {
      ...
      if (item) {
        seterrormessage((old) => {
          return {
            ...old,
            'name': 'Same Name Testimonial already exist'
          }
        })
        return
      }
          ...
          <div className="col-md-9">
            ...
            <form onSubmit={postdata}>
              <div className="row mt-3">
                ...
                <div className='col-md-6 mb-3'>
                  <label>City*</label>
                  <input type="text" name="city" onChange={inputdata} className={`form-control border-3 ${show && errormessage.city ? 'border-danger' : "border-primary"}`} placeholder='Enter city' />
