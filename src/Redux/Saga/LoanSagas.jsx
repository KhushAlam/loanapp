...
function* createSaga(action) {
    let responce = yield call(createRecord, "loan/create", action.payload)
...
function* getSaga(action) {
    let responce = yield call(getRecord, "loan/get", action.payload);
    yield put({ type: GET_LOAN_RED, payload: responce })
}
function* updateSaga(action) {
    let responce = yield call(updateRecord, "loan", action.payload)
    yield put({ type: UPDATE_LOAN_RED, payload: responce })
