...
export default function Personal() {
    ...
    return (
        <>
            <Breadcrum title="Personal-Loan Service" />
            <div className="container-fluid">
                <h1 className='mt-3 btn btn-primary text-light w-100 p-2 mb-3'>Whole Information About Personal Loan</h1>
                <div className="row">
                    <div className="col-md-4">
                        <div className="card shadow-sm p-3 mb-4">
                            <h4 className="mb-3">Small Personal Loan</h4>
                            <p>Quick and easy loans designed to support small Personales with minimal paperwork and fast approval.</p>

                            <h6 className="mt-3">Required Documents:</h6>
                            <ul className="mb-3">
                                <li>Aadhaar / PAN Card (Identity Proof)</li>
                                <li>Personal Registration / GST Certificate</li>
