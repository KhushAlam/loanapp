...
export default function Commercial() {
  ...
  return (
     <>
               <Breadcrum title="Commercial-Loan Service" />
               <div className="container-fluid">
                   <h1 className='mt-3 btn btn-primary text-light w-100 p-2 mb-3'>Whole Information About Business Loan</h1>
                   <div className="row">
                       <div className="col-md-4">
                           <div className="card shadow-sm p-3 mb-4">
                               <h4 className="mb-3">Small Commercial Loan</h4>
                               <p>Quick and easy loans designed to support small businesses with minimal paperwork and fast approval.</p>
                       ...
                       <div className="col-md-8">
                           ...
                           <div className="table-responsive">
                               <div className="d-flex flex-wrap gap-4 p-3 border rounded bg-light">
                                   {serviceStatedata
                                       .filter((x) => x.loantype === "Commercial")
                                       .map((item, index) => (
